...
- We define a return range and anchor for every product (like 1 day returns let's say)
- How people submit their answers will move the actual returns within the range, so if everybody thinks something is a strong buy, price will go up more than our anchor (within the range)
- It's up to you to critically read text and see that some news are good / bad / already priced in, etc.

### A small change was updated to the Ashflow Alpha visual at 12:00 CEST on Wednesday, 29/04 as communicated in Discord.

The updated text is below and will be available in the downloadable image shortly:

Index Committee Confirms Sulfur Ltd. for Elemental Index 118

Elemental Index 118 will add Sulfur Reactor in its upcoming rebalance, according to the index committee's latest notice. The inclusion follows a review of eligible constituents across the elemental processing sector, where Sulfur Reactor's products are regarded as industry benchmarks.
...
Forever Feathers Ltd. is the same as Eternal Feathers Ltd. This is a typo on our end, apologies! This typo has no impact.
