...
SKIP_PRODUCTS = frozenset(
    {
        ...
        "ROBOT_LAUNDRY",
        "ROBOT_IRONING",
        # This is the only extra no-trade product retained. Its spread/volatility
        # profile is poor across days 2-4, so skipping it is less path-specific
        # than tuning inventory behavior from one leaderboard run.
        "PEBBLES_XL",
    }
)

# Conservative version of v6's early-skew list. These names were repeated
# losers under broad v2-style market making and improved under earlier skew.
# I deliberately exclude SLEEP_POD_SUEDE and SNACKPACK_VANILLA here: they
# improved in v6's 1k log, but they are not structurally bad products.
