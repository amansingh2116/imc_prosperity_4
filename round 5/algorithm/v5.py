...
# Products that lost in v2 and where v4's earlier inventory skew reduced the
# damage or turned the product positive. Everything else keeps v2's broader
# carry profile, which is where most of the upside came from.
